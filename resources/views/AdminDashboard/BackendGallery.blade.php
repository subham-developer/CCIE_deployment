...
<section id="main-content">
 ...
 @endif
        ...
        <div class="row"> 
            ...
            @endforeach
            <div id="paginationpage" style="margin-left:25px;">
              {{ $gettingMotivationalImages->links() }}
             
            </div>
            <div class="row" style="text-align:center;">
                <a href="{{ url('/showAllMotivationalImages') }}"><button class="btn btn-lg btn-primary">Show All</button></a>
            </div>
        </div>
